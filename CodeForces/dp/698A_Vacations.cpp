 ...
 * dp[days][0]: minimum days rested up to the current day if we rest on the
 * current day dp[days][1]: minimum days rested up to the current day if we
 * choose contest on the current day dp[days][2]: minimum days rested up to the
 * current day if we choose gym on the current day
 *
 *
 * example: a-> 1 3 2 0
 * ----------------------------------
